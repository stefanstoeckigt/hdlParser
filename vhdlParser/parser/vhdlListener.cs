...
public interface IvhdlListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterConcurrent_simple_signal_assignment([NotNull] vhdlParser.Concurrent_simple_signal_assignmentContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="vhdlParser.concurrent_simple_signal_assignment"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitConcurrent_simple_signal_assignment([NotNull] vhdlParser.Concurrent_simple_signal_assignmentContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="vhdlParser.concurrent_conditional_signal_assignment"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterConcurrent_conditional_signal_assignment([NotNull] vhdlParser.Concurrent_conditional_signal_assignmentContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="vhdlParser.concurrent_conditional_signal_assignment"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitConcurrent_conditional_signal_assignment([NotNull] vhdlParser.Concurrent_conditional_signal_assignmentContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterLogical_expression([NotNull] vhdlParser.Logical_expressionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="vhdlParser.logical_expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitLogical_expression([NotNull] vhdlParser.Logical_expressionContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterName_part_specificator([NotNull] vhdlParser.Name_part_specificatorContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="vhdlParser.name_part_specificator"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitName_part_specificator([NotNull] vhdlParser.Name_part_specificatorContext context);
	/// <summary>
